...
export default function About() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#f6f0e800] py-12 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1400px] mx-auto">
        {/* Header - Mantido como no último ajuste (Nikea e alinhamento esquerdo do texto) */}
        <h2
          ref={titleRef}
          className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 tracking-wider flex items-center text-black font-nikea mt-8 lg:mt-12"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-16 items-start">
          ...
          >
            <p>
              A UFU Saints é a atlética de e-sports da Universidade Federal de Uberlândia. Fundada em 2024, surgiu da vontade de criar um espaço onde jogar fosse também se{" "}
              <strong>conectar, competir e crescer</strong> em equipe. O projeto nasceu como uma nova fase da antiga atlética Santa Bronx, com identidade renovada, novos objetivos e muito mais atitude.
            </p>
            <p>
          ...
          <div className="w-full lg:w-[50%] xl:max-w-[600px] relative aspect-[774/654] lg:ml-auto border-2 border-gray-300 shadow-lg rounded-xl lg:-mt-16">
            {" "}
            {/* <-- Rounded-xl para mais arredondamento */}
            <div
              ref={imageRef}
              className="absolute inset-0 bg-black overflow-hidden rounded-xl"
            >
              {" "}
              {/* <-- Rounded-xl aqui também */}
            ...
            <button
              ref={buttonRef}
              className="absolute -bottom-7 right-[-7px] sm:-right-6 z-20 bg-[#E3A524] hover:bg-yellow-600 text-white font-bold px-8 py-3 rounded-md text-sm uppercase tracking-wide shadow-x1 transition-all transform hover:scale-105 btn-clipped-left btn-3d-effect"
            >
              FAÇA PARTE DO TIME
            </button>
          </div>
